...
<xsl:stylesheet 
  ...
  <xsl:template match="/">
    ...
    <xsl:call-template name="extract-microcontent"/>
    
<!--     <xsl:variable name="topicMicroContent">
    	<xsl:call-template name="extract-microcontent"/>
    </xsl:variable>
    <xsl:message>Topic microcontent: <xsl:copy-of select="$topicMicroContent" /> </xsl:message>
    
    <xsl:call-template name="write-microcontent"> 
    	<xsl:with-param name="microcontent" select="$topicMicroContent" />
    </xsl:call-template> -->
